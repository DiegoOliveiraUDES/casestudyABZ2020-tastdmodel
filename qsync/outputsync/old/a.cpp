...
int  forall_Be_y(int&  y, int&  z)
{
	...
	for(int c : T_B)
	{
		...
		{
			if((std::find(T_B.begin(), T_B.end(), y) !=T_B.end() && forall_Ce_z(ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].z)))
			{
				exec = exec+1;
		...
		}else 
		{
			...
			if(forall_Ce_z(ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].z))
			{
				exec = exec+1;
...
int  forall_Ae_x(int&  x, int&  y, int&  z)
{
	int  exec = 0;
	for(int c : T_A)
	{
		...
		{
			if((std::find(T_A.begin(), T_A.end(), x) !=T_A.end() && forall_Be_y(ts_A.f[ts_A.x].y, ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].z)))
			{
				exec = exec+1;
		...
		}else 
		{
			...
			if(forall_Be_y(ts_A.f[ts_A.x].y, ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].z))
			{
				exec = exec+1;
...
{
	int  exec = 0;
	if(forall_Ae_x(ts_A.x, ts_A.f[ts_A.x].y, ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].z))
	{
		for(int x : T_A)
		{
			ts_A.x = x;
			if(forall_Be_y(ts_A.f[ts_A.x].y, ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].z))
			{
				for(int y : T_B)
				{
					...
					if(forall_Ce_z(ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].z))
					{
						for(int z : T_C)
						{
							ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].z = z;
							if(ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].f[ts_A.f[ts_A.x].f[ts_A.f[ts_A.x].y].z].autState == S0)
							{
